...
# #### MQTT Topics ####
MQTT_TOPICS = {
    'COMMAND': 'xiaodu2ha/command/{username}',  # 从小度到HA的命令
    'REPORT': 'xiaodu2ha/report/{username}',    # 设备状态报告
    'STATE': 'xiaodu2ha/state/{username}',      # 设备状态更新
    'RESPONSE': 'xiaodu2ha/response/{username}' # 命令响应
}
...
# #### Service Api ####
CONST_GET_VERSION_CHECK_URL = '/api/plugin/api_check'
